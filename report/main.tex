...
% TODO: add subsections with basic information from the classical method
...
% TODO: fill in this part of the pipeline once the speech classification part is done

% Results at the end
\section{Results}

% The pipeline has two parts:
% - Inter sentence detection: Detect unsafe parts of the video and cluster on the
% basis of genre spread
%   - Test on bi-LSTM pre-trained
%   - twitter model pretrained
%   - Custom feature twitter model
% - Video zonal clustering and analysis: Now depending on each section labeled, assign
% an overall score to the video with a rough genre distribution

% Success rate and scalable component
\section{Conclusion \& further work}

% TODO: on the basis of the results fill this part in
% - What were the success rates for each part and scores for each.
% - Method finally chosen and final output of the network
% - Current issues and improvements that can be made
% - Future addendum: additional features to be added
